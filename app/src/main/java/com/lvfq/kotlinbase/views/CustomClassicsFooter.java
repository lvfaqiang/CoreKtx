...
public class CustomClassicsFooter extends ClassicsAbstract<ClassicsFooter> implements RefreshFooter {
    ...
    public CustomClassicsFooter(Context context, AttributeSet attrs) {
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextPulling)) {
            ...
            mTextPulling = context.getString(R.string.load_pulling);
        }
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextRelease)) {
            ...
            mTextRelease = context.getString(R.string.load_release);
        }
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextLoading)) {
            ...
            mTextLoading = context.getString(R.string.load_loading);
        }
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextRefreshing)) {
            ...
            mTextRefreshing = context.getString(R.string.load_refreshing);
        }
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextFinish)) {
            ...
            mTextFinish = context.getString(R.string.load_finish);
        }
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextFailed)) {
            ...
            mTextFailed = context.getString(R.string.load_failed);
        }
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextNothing)) {
            ...
            mTextNothing = context.getString(R.string.load_nothing);
        }
