...
/**
 * SwipeRefreshView
 * @author FaQiang on 2017/12/23 上午12:18
 * @Github: <a href="https://github.com/lvfaqiang"/>
 * @Blog: <a href="http://blog.csdn.net/lv_fq"/>
 * @desc : SwipeRefreshLayout 结合 BaseRecyclerViewAdapterHelper
 *
 */
class SwipeRefreshView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : FrameLayout(context, attrs, defStyleAttr), BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
