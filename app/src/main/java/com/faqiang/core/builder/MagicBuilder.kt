package com.faqiang.core.builder
...
import io.douwan.basic.core.ktx.getColorById
import io.douwan.basic.core.ktx.setOnClickListener
...
class MagicBuilder private constructor(private val context: Context) {
    ...
    fun bindView(indicator: MagicIndicator, viewPager: ViewPager2): MagicBuilder {
        this.indicator = indicator
    ...
    private fun initCommonNavigator(context: Context) {
        ...
        if (viewPager2 != null) {
            bindViewPager2(indicator, viewPager2)
        } else if (viewPager != null) {
            ViewPagerHelper.bind(indicator, viewPager)
        }
    }

    private fun bindViewPager2(magicIndicator: MagicIndicator?, viewPager: ViewPager2?) {
